...
export const routes: Routes = [
  ...
  // CRUD operations using the same component for simplicity
  
  { path: 'crud/create', component: CrudComponent },
  { path: 'crud/read', component: CrudComponent },
  { path: 'crud/update', component: CrudComponent },
  { path: 'crud/delete', component: CrudComponent },
];
